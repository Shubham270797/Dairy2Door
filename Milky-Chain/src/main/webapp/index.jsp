                ...
                <div class="col-lg-9 offset-lg-2 text-center">
                    <div class="hero-text">
                        <div class="hero-text-tablecell">
                            <h1>Welcome to Milky-Chain </h1>
                            <p class="subtitle">Freshness in taste...delivered at your doorstep </p>
                        
                          <p>It has a committed vision to ease the workflow between distribuitor as well as customer
                              by managing milk distribution at doorstep with automated functionlities & web based technology.
                          </p>
                            <div class="hero-btns">
                                <a href="shop.jsp" class="boxed-btn">Milk Collection</a>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 text-center">
                    <div class="section-title"> 
                        ...
                        <p>We Bring Milk At Your Door Steps.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="single-product-item">
                       ...
                       <!--  <p class="product-price"><span>Per Litre</span> Rs.70 </p>
                ...
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="single-product-item">
                        ...
                        <h3>Tonned Milk</h3>
                       <!--  <p class="product-price"><span>Per Litre</span> Rs.80 </p>
                        <a href="cart.jsp" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a> -->
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0 text-center">
                    <div class="single-product-item">
                        ...
                        <h3>Butter Milk</h3>
                        <!-- <p class="product-price"><span>Per Litre</span> Rs.90 </p>
                        <a href="cart.jsp" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a> -->
                    </div>
                </div>
            </div>
