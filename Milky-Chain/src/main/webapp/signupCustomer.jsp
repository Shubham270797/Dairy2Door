			...
			<div class="row">
				<div class="col-lg-8 mb-5 mb-lg-0">
					...
					<div class="contact-form">
						...
						<form:form method="POST" action="customer/addCustomer" modelAttribute="customer">
							<p>
								<p><label>First Name:</label><input type="text" placeholder="First Name" name="customerFname" id="customerFname"></p>
								<p><label>Last Name:</label><input type="text" placeholder="Last Name" name="customerLname" id="customerLname"></p>
                                <p><label>Address:</label><input type="text" placeholder="Address" name="customerAddress" id="customerAddress"></p>
                                <p><label>Mobile No:</label> <input type="text" placeholder="Mobile No" name="customerMobileNo" id="customerMobileNo"></p>
								<p><label>Email Id:</label><input type="email" placeholder="Email Id" name="customerEmail" id="customerEmail"></p>
								<p><label>Username:</label><input type="text" placeholder="Username" name="customerUsername" id="customerUsername"></p>
								<p><label>Customer Area:</label><input type="text" placeholder="Area" name="customerArea" id="customerArea"></p>
								<p><label>Pincode:</label><input type="text" placeholder="Pincode" name="customerPincode" id="customerPincode"></p>
							    <p><label>Password:</label><input type="text" placeholder="Confirm password" name="customerPassword" id="customerPassword"></p>
                            </p>
				...
				<div class="col-lg-3 col-md-6">
					<div class="footer-box pages">
						...
						<ul>
							...
							<li><a href="news.html">News</a></li> -->
							<li><a href="contact.jspl">Contact Us</a></li>
						</ul>
					</div>
				</div>
				<!-- <div class="col-lg-3 col-md-6">
