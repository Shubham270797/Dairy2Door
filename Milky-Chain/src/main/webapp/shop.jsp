			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="breadcrumb-text">
					    <h1>Daily Milk Handling</h1>
						<p>Milk Collection and Processing Capacity</p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row product-lists">
				<div class="col-lg-4 col-md-6 text-center Pasterized Milk">
					<div class="single-product-item">
						...
						<p class="product-price"><span>Production in Ltr</span> 500   </p>
				...
				<div class="col-lg-4 col-md-6 text-center Tonned Milk">
					<div class="single-product-item">
						...
						<h3>Tonned Milk</h3>
						<p class="product-price"><span>Production in Ltr</span> 400 </p>
						<!-- <a href="cart.jsp" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a> -->
					</div>
				</div>
