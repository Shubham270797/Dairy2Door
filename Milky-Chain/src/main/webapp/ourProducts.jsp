...
<!-- end header -->
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="breadcrumb-text">
					    <h1>Our Wholesome Range</h1>
						<p>The taste of nutrition</p>
                ...
                <div class="col-md-12">
                    <div class="product-filters">
                        <ul>
                            ...
                            <li data-filter=".strawberry">Pasterized Milk</li>
                            <li data-filter=".berry">Tonned Milk</li>
                            <li data-filter=".lemon">Skimmed Milk</li>
                        </ul>
                    </div>
                </div>
            </div>
 -->
			<div class="row product-lists">
				...
				<div class="col-lg-4 col-md-6 text-center Pasterized Milk">
					<div class="single-product-item">
						...
						<h4>Pasterized Milk</h4>
						<p class="product-price"><span>Per Ltr</span> Rs.60</p>
						<!-- <p class="product-price"><span>Per Lt</span> Rs.70 </p> -->
						<!-- <a href="cart.jsp" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add Product</a> -->
					</div>
				</div>
				
				<div class="col-lg-4 col-md-6 text-center Tonned Milk">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.jsp"><img src="assets/img/products/product-img-2.jpg" alt=""></a>
						</div>
						<!-- <h4>Product Id:2</h4> -->
						<p class="product-price"><span>2</span></p>
						<h3>Tonned Milk</h3>
						<p class="product-price"><span>Per Ltr</span> Rs.50 </p>
						<!-- <a href="cart.jsp" class="cart-btn"><i class="fas fa-shopping-cart"></i>Add Product </a> -->
					</div>
				</div>
				<div class="col-lg-4 col-md-6 text-center Skimmed Milk">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.jspl"><img src="assets/img/products/product-img-3.jpg" alt=""></a>
						</div>
						<p class="product-price"><span>3</span></p>
						<h3>Butter Milk</h3>
						<p class="product-price"><span>Per Ltr</span> Rs.70</p>
						<!-- <a href="cart.jsp" class="cart-btn"><i class="fas fa-shopping-cart"></i>Add Product</a> -->
					</div>
				</div> 
