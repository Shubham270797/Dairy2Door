...
<head>
	...
	<!-- title -->
	<title>View Complaint Section</title>
					...
					<div class="main-menu-wrap">
						...
						<nav class="main-menu">
							<ul>
								...
								<li><a href="contact.html">Our Supplier</a></li>
								<li><a href="contact.html">Chcek By Location</a></li>
				...
				<div class="col-lg-8 mb-5 mb-lg-0">
					...
					<div class="contact-form">
						...
						<form type="POST" id="fruitkha-contact" onSubmit="return valid_datas( this );">
							<p>
								<p><label>Full Name:</label><input type="Full Name" placeholder="FullName" name="Full Name" id="Full Name"></p>
                                <label for="date">Date of Complaint: </label>
                                <input type="date" id="date" name="date">
                               
                               
							   <p><label>Complaint Status:</label><input type="Complaint Status" placeholder="Complaint Status" name="Complaint Status" id="Complaint Status"></p>
                               <p><label>Complaint Information:</label><input type="Text Area" placeholder="Complaint" name="Complaint" id="Complaint"></p>
							  
							   
							   
                            </p>

							<p><input type="submit" value="File Complaint"></p>
						</form>
					</div>
				</div>
				<div class="col-lg-4">
