			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="breadcrumb-text">
						<p>our customers are partners in our mission</p>
						<h1> Our Customers</h1>
					</div>
				</div>
			</div>
				...
				<div class="col-lg-1">
					<div class="order-details-wrap">
						<table class="order-details">
							<thead>
								<tr>
									<th><b>Customer Fname</b></th>
									<th><b>Customer Lname</b></th>
							...
							<tbody class="order-details-body">
								<tr>
									<td>Manasvi </td>
									<td>Gijare</td>
                                    <td><p>	Pure Dairy,Eastern Complex, 
                                        Near Ambedkar Square,Pimpri_Chinchwad,Pune</p></td>
                                    <td>9850447705</td> 
                                    <td>Gijaremanasvi@gmail.com</td>
                                    <td>Gijarem</td>
                                    <td>man</td>
                                    <td>415110</td>
                                    <td>karad</td>
