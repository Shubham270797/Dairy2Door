...
<body>
			 ...
			 <div class="col-lg-15">
					...
					<div class="order-details-wrap">
						<table class="order-details">
							<thead>
								<tr>
									<th><h4><i class="fas fa-map"></i> Main Office Address</h4></th>
									<th><h4><i class="far fa-clock"></i> Office Hours</h4></th>
									<th><h4><i class="fas fa-address-book"></i> Contact</h4></th>
							...
							<tbody class="order-details-body">
								<tr>
									<td><p>503, Mayfair Tower S Phase-Ii, Wakdewadi, Shivajinagar <br> Near Bank Of India,
										<br> Pune, Maharashtra 411005 .</p></td>
									<td><p>MONDAY - FRIDAY: 8 to 9 PM <br> SAT - SUN: 10 to 8 PM </p></td>
                                    <td><p>Contact No.: +91-20-26450045 <br> Email: support@MilkyChain.com</p></td>
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="section-title">
						...
						<p>Don't work for recognition but do work worthy of recognition.</p>
			...
			<div class="row">
				<div class="col-lg-2 col-md-3 offset-md-1">
					<div class="single-team-item">
						...
						<h4>Shubham <span>Developer</span></h4>
				...
				<div class="col-lg-2 col-md-4">
					<div class="single-team-item">
						...
						<h4>Sonal  <span>Developer</span></h4>
						<ul class="social-link-team">
				...
				<div class="col-lg-2 col-md-4">
					<div class="single-team-item">
						<div class="team-bg team-bg-2"></div>
						<h4>Manasvi <span>Developer</span></h4>
						<ul class="social-link-team">
				...
				<div class="col-lg-2 col-md-4">
					<div class="single-team-item">
						<div class="team-bg team-bg-1"></div>
						<h4>Sairaj <span>Developer</span></h4>
						<ul class="social-link-team">
				...
				<div class="col-lg-2 col-md-4 offset-md-3 offset-lg-0">
					<div class="single-team-item">
						...
						<h4>Aakash <span>Developer</span></h4>
						<ul class="social-link-team">
	...
	<!-- <section>
		<div class="contact-map">
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3783.5066755631024!2d73.93931731445782!3d18.50599198741739!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2c21c79610b49%3A0xe5bdcb2ac41ad44d!2sMilky-Chain+Farms+Milk+%7C+A2+Milk-+Gir+Cows+Milk+%7C+Desi+Cow+Milk+Farm+Pune!5e0!3m2!1sen!2sin!4v1528983040094" width="1350" height="476" frameborder="0" style="border:0" allowfullscreen></iframe>
		</div>
		</section>
		</div> -->
	...
	<!-- <div class="embed-responsive embed-responsive-21by9">
		...
		sen!2sbd" width="400" height="450" frameborder="0" style="border:0;" allowfullscreen="" class="embed-responsive-item"></iframe>
