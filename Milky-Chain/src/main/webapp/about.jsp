			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="breadcrumb-text">
						<h1>About Us</h1>
                            <br><br>
						<p>Freshness in taste delivered at your doorstep</p>
			...
			<div class="row">
				<div class="col-lg-7">
					<div class="featured-text">
						<h2 class="pb-3">Why <span class="orange-text">MilkyChain?</span></h2>
						<div class="row">
							<div class="col-lg-6 col-md-6 mb-4 mb-md-5">
								<div class="list-box d-flex">
									...
									<div class="content">
										<h3>Door Steps Milk Delivery</h3>
										<!-- <p>Free Home Delivery.We Bring Milk At Your Door Steps</p> -->
									</div>
								</div>
							</div>
							...
							<div class="col-lg-6 col-md-6">
								<div class="list-box d-flex">
									...
									<div class="content">
										<h3> Automated Billing & Distribution Management</h3>
										<p></p>
									</div>
								</div>
							</div>
