				...
				<!-- <div class="col-lg-8">
					<div class="checkout-accordion-wrap">
						  ...
						  <div class="card single-accordion">
						    <div class="card-header" id="headingOne"> -->
						      ...
						      <!-- </h5> -->
									...
									<h3 style="align-content: center;"> Generate Bill  </h3>
									<br>
						    </div>
                      ...
                      <div class="customer-sign-up">
                        ...
                        <form method="post" action="/SupplierViews/generateBill" id="fruitkha-contact" >
						            <!-- first name -->
                        <label for="customerId">Enter Customer Id</label>
                        <p><input type="number" name="customerId" id="customerId" placeholder="customerId"></p>
                        <!-- last name -->
