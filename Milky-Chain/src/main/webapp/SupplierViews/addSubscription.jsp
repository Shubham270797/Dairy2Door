...
<head>
	...
	<!-- title -->
	<title>Supplier Registratiom</title>
			...
			<!-- <div class="col-lg-8">
				<div class="checkout-accordion-wrap">
					  ...
					  <div class="card single-accordion">
						<div class="card-header" id="headingOne"> -->
						  ...
						  <!-- </h5> -->
								...
								<h3 style="align-content: center;"> Add  Subscription </h3>
								<br>
						</div>
				  ...
				  <div class="customer-sign-up">
					...
					<form method="post" action="/SupplierViews/addSubscription" id="fruitkha-contact" >
				

					<!-- customer_id -->
					<label for="customer_id">Enter Customer Id</label>
					<p><input type="text" name="customerId" id="customerId"placeholder="Customer Id"></p>
					<!-- product_id -->
					<label for="product_id">Enter Product Id</label>
					<p><input type="text" name="productId" id="productId"placeholder="Product Id"></p>
					<!-- supplier_id"-->
					<label for="supplier_id">Enter Supplier Id</label>
					<p><input type="text" name="supplierId" id="supplierId" placeholder="SupplierId"></p>
					<!-- subscription_start_date -->
					<label for="subscription_start_date">Enter Subscription Start Date </label>
					<p><input type="date" name="subscriptionStartDate " id="subscriptionStartDate " placeholder="Subscription Start Date(yyyy-mm-dd) "></p>
					<!-- subscription_end_date  -->
					<label for="subscription_end_date ">Enter Subscription End Date </label>
					<p><input type="date" name="subscriptionEndDate " id="subscriptionEndDate " placeholder="Subscription Etart Date(yyyy-mm-dd) "></p>
					<label for="milk_quantity_ltr">Enter Milk Quantity</label>
					<p><input type="text" name="milkQuantityLtr" id="milkQuantityLtr" placeholder="Milk Quantity"></p>
