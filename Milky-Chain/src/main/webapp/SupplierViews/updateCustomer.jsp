							...
							<ul>
								...
								<li class="current-list-item"><a href="#">Subscription</a>
									<ul class="sub-menu">
										...
										<li><a href="viewSubscriber.jsp">View Subscriber</a></li>
				...
				<!-- <div class="col-lg-8">
					<div class="checkout-accordion-wrap">
						  ...
						  <div class="card single-accordion">
						    <div class="card-header" id="headingOne"> -->
						      ...
						      <!-- </h5> -->
									...
									<h3 style="align-content: center;"> Update Customer </h3>
									<br>
						    </div>
                      ...
                      <div class="customer-sign-up">
                        ...
                        <form type="POST" action="supplier/" id="fruitkha-contact" >
                          <!-- Id -->
                          <label for="customerId"> Id</label>
                          <p><input type="text" name="customerId" id="customerId"placeholder="Id"></p>    
						            <!-- first name -->
                       ...
                       <p> <textarea name="customerAddress" id="customerAddress" placeholder="Address"cols="140" rows="5"></textarea></p>
                        <!-- customerMobileNo-->
                        <label for="Mobile">Enter Mobile Number</label>
                        <p><input type="number" name="customerMobileNo" id="customerMobileNo" placeholder="Mobile Number"></p>
                        <!-- customerEmail -->
                       ...
                       <p> <textarea name="Shipping Address" id="Shipping Address" placeholder="Shipping Address"cols="140" rows="5"></textarea></p> -->
                        ...
                        <label for="Password">Enter Password</label>
						        		<p><input type="password" name="customerPassword" id="customerPassword" placeholder="Password"></p>
                        <!-- customerPincode -->
				...
				<div class="col-lg-3 col-md-6">
					<div class="footer-box pages">
						...
						<ul>
							...
							<li><a href="about.html">About Us</a></li>
							<li><a href="ourProducts.html">Our Product</a></li>
