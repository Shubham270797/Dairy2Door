	...
	<table border="1" align="center" width="80%" class="order-details">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><b>Subscription Start Date</b></th>
                                                <th><b>subscription End Date</b></th>
                                                <th><b>Subscription Status</b></th>
                                                <th><b>Milk Quality ltr</b></th>
												<th><b>Action</b></th>    
                                            </tr>
                                        </thead>
                                        <tbody class="order-details-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>${subscriber.customerInfoTable.customerFname} ${subscriber.customerInfoTable.customerLname}</td>
                                                <td>${subscriber.milkProductionTable.productName }</td>
                                                <td>${subscriber.supplierInfoTable.Fname} ${subscriber.supplierInfoTable.Lname}</td>
												<td>${subscriber.subscriptionStartDate}</td>
												<td>${subscriber.subscriptionEndDate }</td>
												<td>${subscriber.subscriptionStatus}</td>
												<td>${subscriber.milkQuantityLt }</td>
												<td><a href="/SupplierViews/endSubscription/?subscriptionId=${subscriber.subscriptionId}">Terminate</a>
													<br><a href="/SupplierViews/nonDeliveryRecord?subscriptionid=${subscriber.subscriptionId}">Undelivery</a>
                                            </tr>
                                            </c:forEach>
                                            <%-- <tr>
                                                <td>2</td>
												...
												<td>Active</td>
												<td>5</td>
												<td><a href="/supplier/?id=${supplier.subscriptionId}">Terminate</a>
													<br><a href="/supplier/nonDeliveryRecord?id=${supplier.subscriptionId}">Undelivery</a>
