					...
					<table border="1" align="center" width="80%" class="order-details">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><b>Order Delivery Date</b></th>
												<th><b>Order Status</b></th>
												<th><b>Total Order Cost</b></th>
												<th><b>Action</b></th>
                                            </tr>
                                        </thead>
                                        ...
                                        <c:forEach  var="order" items="${orders}">
                                            <tr>
                                                <td>${order.orderId}</td>
                                                <td>${order.customerId.customerFname} ${order.customerId.customerLname}</td>
												<td>${order.milkProductionTable.productName }</td>
                                                <td>${order.supplierInfoTable.supplierFname} ${order.supplierInfoTable.supplierLname} </td>
												<td>${order.orderDate}</td>
                                                <td>${order.orderQuantity}</td>
                                                <td>${order.orderDeliveryDate}</td>
												<td>${order.orderStatus}</td>
                                                <td>${order.totalOrderCost}</td>         
												<td><a href="/SupplierViews/acceptOrders?id=${supplier.orderId}">Accept</a>
													<br><a href="/SupplierViews/rejectOrders?id=${supplier.orderId}">Reject</a>
													<br><a href="/SupplierViews/deliverdOrders?id=${supplier.orderId}">Delivered</a></td>
                                            </tr>
                                            </c:forEach>
                                           <%--  <tr>
                                                <td>2</td>
                                                ...
                                                <td>Active</td>
                                                <td>2</td>
                                                <td><a href="/supplier/acceptOrders?id=${supplier.orderId}">Accept</a>
													<br><a href="/supplier/rejectOrders?id=${supplier.orderId}">Reject</a>
													<br><a href="/supplier/deliverdOrders?id=${supplier.orderId}">Delivered</a></td>
