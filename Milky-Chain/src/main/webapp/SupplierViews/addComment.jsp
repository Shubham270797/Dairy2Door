						...
						<nav class="main-menu">
							<ul>
								...
								<li class="current-list-item"><a href="#">Order</a>
									<ul class="sub-menu">
										<li><a href="showOrders.html">Show Orders</a></li>
				...
				<!-- <div class="col-lg-8">
					<div class="checkout-accordion-wrap">
						  ...
						  <div class="card single-accordion">
						    <div class="card-header" id="headingOne"> -->
						      ...
						      <!-- </h5> -->
									...
									<h3 style="align-content: center;"> Add Comment </h3>
									<br>
						    </div>
                      ...
                      <div class="customer-sign-up">
                                        ...
                                        <form type="POST"action="supplier/addComment" id="fruitkha-contact" >
						            <!-- comment Id -->
                        <label for="commentid"> ID</label>
                        <p><input type="number" name="commentid" id="commentid"placeholder="ID"></p>
                        <!-- Supplier Id -->
                        
						<!-- commment -->
                        <label for="comment_text">Add  Comment</label>
                       <p> <textarea name="comment_text" id="comment_text" placeholder="Comment"cols="140" rows="5"></textarea></p>
