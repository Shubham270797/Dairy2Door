                                            ...
                                            <tr>
                                               <tr>
									                 ...
									                 <td>${customer.customerMobileNo}</td>
                                                        <td>${supplier.customerEmail}</td>
                                                     <td><p>${supplier.customerAddress}</p></td>
                                                      <td>${supplier.customerUsername}</td>
                                                       <td>${supplier.customerPassword}</td>
                                                          <td>${supplier.customerPincode}</td>
                                                          
								</tr>
                                                
												<!-- <td><a href="/supplier/acceptOrders?id=${supplier.orderId}">Update</a> -->
                                                    <td><a href="updateCustomer.html">Update</a></td>
