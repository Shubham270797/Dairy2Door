			...
			<div class="row">
				<!-- <div class="col-lg-8">
					<div class="checkout-accordion-wrap">
                        ...
                        <p><form method="post" action="/SupplierViews/customerInArea" id="fruitkha-contact" ></p>
						            <!-- Supplier Id -->
                        <label for="pincode">Enter Pincode:</label>
                        <p><input type="text" name="supplierPincode" id="supplierPincode"placeholder="Pincode"></p>
