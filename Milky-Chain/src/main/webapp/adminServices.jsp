                    ...
                    <nav class="main-menu">
                        ...
                        <!--     <li><a href="about.jsp">About  Us</a></li> -->
                            <li class="current-list-item"><a href="#">Supplier</a>
                                <ul class="sub-menu">
                                    <li><a href="AdminViews/addSupplier.jsp">Add Supplier</a></li>
							...
							<li class="current-list-item"><a href="#">Product</a>
                                <ul class="sub-menu">
                                    <li><a href="AdminViews/addProduct.jsp">Add Product</a></li>
                                    <li><a href="AdminViews/changeRate.jsp">Change Rate</a></li>
                                </ul>
                            </li>
...
<div class="product-section mt-150 mb-150">
	...
	<!-- 	<div class="row">
			...
			<div class="col-lg-4 col-md-3 text-center">
				<div class="single-product-item">
					<div class="product-image">
						<a href="#"><img src="assets/img/view product.jpg" alt=""></a>
					</div>
					<h3>View Product</h3>
			...
			<div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0 text-center">
				<div class="single-product-item">
					<div class="product-image">
						<a href="complaint.html"><img src="assets/img/add product.jpg" alt=""></a>
					</div>
					<h3>Add Product</h3>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0 text-center">
				<div class="single-product-item">
					<div class="product-image">
						<a href="managesupplier.html"><img src="assets/img/manage supplier.jpg" alt=""></a>
					</div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-box pages">
                    ...
                    <ul>
                        ...
                        <li><a href="AdminViews/addsupplier.jsp">Add Supplier</a></li>
                        <li><a href="/AdminViews/viewSupplierList">View Supplier</a></li>
                        <li><a href="AdminViews/addProducts.jsp">Add Product</a></li>
                        <li><a href="AdminViews/changeRate.jsp">changeRate</a></li>
