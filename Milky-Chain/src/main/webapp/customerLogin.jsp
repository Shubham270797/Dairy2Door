...
<!-- end header -->
	...
	<p><h1 style="color: red">${success}</h1></p>
			...
			<div class="row">
				...
				<div id="form_status"></div>
					<div class="contact-form">
						<form method="post" id="fruitkha-contact" action="${pageContext.request.contextPath}/customerLogin">
							<p>
							...
							<p>
								...
								<p><input type="submit" class="boxed-btn" value="Login"/>
								<a type="submit" href="signupCustomer.jsp" class="boxed-btn" >Non-Subscriber</a></p>	
						</form>
					</div>
				</div>
				 ...
				 <div class="col-lg-4">
					<div class="contact-form-wrap">
						<div class="contact-form-box">
							...
							<h4><i class="fas fa-map"></i> Main Office Address</h4>
