			...
			<div class="row">
				<div class="col-lg-8 mb-8 mb-lg-0">
					...
					<div class="contact-form">
						<form method="post" action="/AdminViews/changeRateOfProduct" id="fruitkha-contact" >
							<p>
								<input type="text" placeholder="Product Id" name="productId" id="productId">
							</p>
							
							<p>
								<input type="text" placeholder="New Rate" name="newRate" id="newRate">
							</p>

							<!-- <p><a href="afteradminlogin.html" class="boxed-btn">Log In</a> -->
								<!-- <a href="" class="boxed-btn">Update</a> -->
