				...
				<!-- <div class="col-lg-8">
					<div class="checkout-accordion-wrap">
						  ...
						  <div class="card single-accordion">
						    <div class="card-header" id="headingOne"> -->
						      ...
						      <!-- </h5> -->
									...
									<h3 style="align-content: center;"> Update Supplier </h3>
									<br>
						    </div>
                      ...
                      <div class="customer-sign-up">
                         ...
                         <form:form method="post" action="/AdminViews/addSupplierInDb" modelAttribute="supplier">
                        <!-- supplierid-->
                        <label for="suppliee">Id</label>
                        <p>${supplier.supplierId}</p>
                      
						<!-- supplierFname-->
                        <label for="supplierFname">First Name</label>
                        <p><input type="text" name="supplierFname" id="supplierFname"placeholder="First Name" value="${supplier.supplierFname}"></p>
                        <!-- supplierLname -->
                        <label for="supplierLname">Last Name</label>
                        <p><input type="text" name="supplierLname" id="supplierLname"placeholder="Last Name" value="${supplier.supplierLname}"></p>
                        <!-- supplierAddress -->
                        <label for="supplierAddress">Enter  Address</label>
                       <p> <input type="text" name="supplierAddress" id="supplierAddress" placeholder="Address" value="${supplier.supplierAddress}"></p>
                        <!-- supplierMobileNo-->
                        <label for="supplierMobileNo">Enter Mobile Number</label>
                        <p><input type="text" name="supplierMobileNo" id="supplierMobileNo" placeholder="Mobile Number" value="${supplier.supplierMobileNo}"></p>
                        <!-- supplierEmail" -->
                        <label for="supplierEmail">Email Id</label>
                        <p><input type="email" name="supplierEmail" id="supplierEmail" placeholder="Email" value="${supplier.supplierEmail}"></p>
                       ...
                       <p> <textarea name="Shipping Address" id="Shipping Address" placeholder="Shipping Address"cols="140" rows="5"></textarea></p> -->
						...
						<p><input type="text" name="supplierUsername" id="supplierUsername"placeholder="Username" value="${supplier.supplierUsername}"></p>
                        <!-- supplierPassword" -->
                        <label for="Password">Enter Password</label>
						<p><input type="text" name="supplierPassword" id="supplierPassword" placeholder="Password" value="${supplier.supplierPassword}"></p>
						<!-- supplierWorkArea-->
                        <label for="workArea">Work Area</label>
						<p><input type="text" name="supplierWorkArea" id="supplierWorkArea"placeholder="Work Area" value="${supplier.supplierWorkArea}"></p>
                        <!--Pincode -->
                       <label for="Pincode">Pincode</label>
                       <p><input type="text" name="supplerWorkAreaPincode" id="supplerWorkAreaPincode" placeholder="Pincode" value="${supplier.supplerWorkAreaPincode}"></p>
