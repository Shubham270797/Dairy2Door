						  ...
						  <div class="card single-accordion">
						    <div class="card-header" id="headingOne"> 
						      ...
						      <!-- </h5> -->
									...
									<h3 style="align-content: center;"> Supplier Registartion </h3>
									<br>
						    </div>
			  ...
			  <div class="billing-address-form">
                  <div class="customer-sign-up">  	
                     <form:form method="post" action="/AdminViews/addSupplierInDb" modelAttribute="supplier">
                        ...
                        <p><input type="text" name="supplierFname" id="supplierFname"placeholder="supplierFname"></p>
                        <!-- last name -->
                        <label for="last name">Enter Last Name</label>
                        <p><input type="text" name="supplierLname" id="supplierLname"placeholder="Last Name"></p>
                        <!-- Billing Address -->
                        <label for=" Address">Enter  Address</label>
                        <p><input type="text" name="supplierAddress" id="supplierAddress" placeholder="Address"></p>
                      <!--  <p> <textarea id="supplierAddress" name="supplierAddress" placeholder="Address"cols="10" rows="3"></textarea></p> -->
                        <!-- Mob -->
                        <label for="Mobile">Enter Mobile Number</label>
                        <p><input type="text" name="supplierMobileNo" id="supplierMobileNo" placeholder="Mobile Number"></p>
                        <!-- Email -->
                        <label for="Email">Enter Email Id</label>
                        <p><input type="email" name="supplierEmail" id="supplierEmail" placeholder="Email"></p>
                        <label for="Username">Enter User Name</label>
						<p><input type="text" name="supplierUsername" id="supplierUsername"placeholder="Username"></p>
                        <!-- password -->
                        <label for="Password">Enter Password</label>
						<p><input type="text" name="supplierPassword" id="supplierPassword" placeholder="Password"></p>
                        <!-- confirm password -->
                        <label for="workArea">Work Area</label>
						 <p><input type="text" name="supplierWorkArea" id="supplierWorkArea" placeholder="Work Area"></p>
                        <!-- Pincode -->
                       <label for="Pincode">Enter Pincode</label>
                       <p><input type="text" name="supplerWorkAreaPincode" id="supplerWorkAreaPincode" placeholder="Pincode"></p>                
                        <!-- submit -->
